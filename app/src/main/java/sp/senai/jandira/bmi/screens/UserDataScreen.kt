package br.senai.sp.jandira.BMI.UserDataScreen
        ...
        modifier = Modifier
            ...
            .background(
                brush = Brush.linearGradient(
                    listOf(Color(0xFF4312AB), Color(0xFF000000))
                )
            ),
                    ...
                    Row(
                            ...
                            Card(
                                ...
                                border = BorderStroke(
                                    2.dp, Brush.linearGradient(
                                        listOf(Color(0xFF7D55A4), Color(0xFF0D2EC5))
                                    )
                                ),
                                elevation = CardDefaults.elevatedCardElevation(2.dp)
                            ) {
                                Image(
                                    painter = painterResource(id = R.drawable.jogador),
                        ...
                        Column(
                            ...
                            Card(
                                ...
                                border = BorderStroke(
                                    2.dp, Brush.linearGradient(
                                        listOf(Color(0xFFE813E4), Color(0xFFBA88FF))
                                    )
                                ),
                                elevation = CardDefaults.elevatedCardElevation(2.dp)
                            ) {
                                Image(
                                    painter = painterResource(id = R.drawable.jogadora),
                                    contentDescription = stringResource(id = R.string.Logo),
                                    modifier = Modifier.fillMaxSize(),
                                    contentScale = ContentScale.Crop
                                )
                    ...
                    Button(
                        ...
                        border = BorderStroke(
                            1.dp, Brush.linearGradient(
                                listOf(Color(0xFF5608A4), Color(0xFFBA88FF))
                            )
                        ),
